...
/***/ function(module, exports, __webpack_require__) {
	...
	var magicalMenu = new _MobileMenu2.default();
	var modal = new _modal2.default();
	new _stickyHeader2.default((0, _jquery2.default)('h1.large-hero__title '));
				...
				this.itemsToReveal.each(function (i, v) {
					...
					new Waypoint({
						...
						handler: function handler() {
							(0, _jquery2.default)(v).addClass('reveal-item--is-visible');
						},
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StickyHeader = function () {
		...
		_createClass(StickyHeader, [{
			...
			value: function createHeaderWaypoiny() {
				var that = this;
					...
					new Waypoint({
						...
						handler: function handler(direction) {
							if (direction == "down") {
								...
								(0, _jquery2.default)('.primary_nav a').removeClass('is-current-link');
